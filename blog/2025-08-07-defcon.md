...
1. Clone repositories, get dependencies and build code
    ...
    ```
    Note that this requires the [Rust](https://www.rust-lang.org/tools/install) and [NPM](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) toolchains. Note: You may need to run `rustup update` if your Rust installation is out of date.
...
> ℹ️ If you don't see the **Plugins** tab, make sure you enabled ["Developer mode"](#developper-mode)
